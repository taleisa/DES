...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Step 1 (Initial Permutation): Input: (Original plaintext block: "
                ...
                + arrayToString(messageAfterIP) + "Left-Half: " + arrayToString(messageLeftHalf) + " Right-Half: "
        ...
        for (int i = 0; i < 16; i++) {
            ...
            System.out.println("Step 2 (Expansion Permutation): Input: (32-bit Right-Half: "
                    + arrayToString(messageRightHalf) + " ) Output: (48-bit expanded block)" + arrayToString(messageAfterEP));
            ...
            System.out.println(
                    "Step 3 (Round Key Addition): Input: (48-bit output from the expansion permutation: "
                            + arrayToString(messageAfterEP) + " , 48-bit Round key: "
                            + roundkeys.get("key" + i)
                            + " ) Output: " + XORwithKey);
            ...
            System.out.println(
                    "Step 6 (XOR): Input: (32-bit output from the P-Box: "
                            ...
                            + arrayToString(messageLeftHalf) + " ) Output: (Afer XORing: "
                            + XORwithLeftHalf);
