...
public class Main {
        ...
        public static void main(String[] args) {
                ...
                char[] messageAfterIP = // Permutating based on the Initial Permutation fixed matrix (64-bit).
                                {
                                                messageArray[57], messageArray[49], messageArray[41], messageArray[33],
                                                messageArray[25], messageArray[17], messageArray[9], messageArray[1],
                                                messageArray[59], messageArray[51], messageArray[43], messageArray[35],
                                                messageArray[27], messageArray[19], messageArray[11], messageArray[3],
                                                messageArray[61], messageArray[53], messageArray[45], messageArray[37],
                                                messageArray[29], messageArray[21], messageArray[13], messageArray[5],
                                                messageArray[63], messageArray[55], messageArray[47], messageArray[39],
                                                messageArray[31], messageArray[23], messageArray[15], messageArray[7],
                                                messageArray[56], messageArray[48], messageArray[40], messageArray[32],
                                                messageArray[24], messageArray[16], messageArray[8], messageArray[1],
                                                messageArray[58], messageArray[50], messageArray[42], messageArray[34],
                                                messageArray[26], messageArray[18], messageArray[10], messageArray[2],
                                                messageArray[60], messageArray[52], messageArray[44], messageArray[36],
        ...
        public static HashMap<String, String> splitAndJoin(char[] keyArray) {
                ...
                char[] leftHalf = Arrays.copyOfRange(keyArray, 0, (keyArray.length / 2) - 1);// The left half also known
                                                                                             // as C0
                char[] rightHalf = Arrays.copyOfRange(keyArray, keyArray.length / 2, keyArray.length - 1);// The right
                                                                                                          // half also
                                                                                                          // known as D0
                for (int i = 0; i < 16; i++) {
                        if (i == 1 || i == 2 || i == 9 || i == 16) {// In the 1st 2nd 9th and 16th round rotate by one
                                                                    // position
                        ...
                        for (int j = 0; j < 56; j++) {
                                if (i < 28) {// To add the left array(first 28 bits)
                                        ...
                                        joined[i] = rightHalf[i - 28];// We subtract 28 because at iteration 28 we want
